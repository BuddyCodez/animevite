...
const Watch = ({ animeId, epNumber }: { animeId: string; epNumber: string }) => {
    ...
    const { data: epData, isLoading: epLoading } = useFetcher(siteConfig.apiUrl + `/anime/zoro/watch?episodeId=${zoroEpId}&server=vidstreaming`) as { data: EPData, isLoading: boolean };
    // console.log(epData);
